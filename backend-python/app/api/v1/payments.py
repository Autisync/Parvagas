...
_DEFAULT_PLANS = [
    {"code": "free", "name": "Grátis", "price": 0, "interval": "month",
     "features": ["1 vaga ativa", "Candidaturas ilimitadas"], "max_active_jobs": 1, "candidate_search_included": False, "api_access_included": False},
    {"code": "starter", "name": "Starter", "price": 25000, "interval": "month",
     "features": ["5 vagas ativas", "Destaque básico", "Suporte por email"], "max_active_jobs": 5, "candidate_search_included": False, "api_access_included": False},
    {"code": "business", "name": "Business", "price": 75000, "interval": "month",
     "features": ["Vagas ilimitadas", "Vagas em destaque", "Acesso à base de CVs", "Analytics", "Acesso à API"], "max_active_jobs": -1, "candidate_search_included": True, "api_access_included": True},
    {"code": "featured_post", "name": "Vaga em Destaque", "price": 15000, "interval": "one_time",
     "features": ["1 vaga destacada por 30 dias"], "max_active_jobs": -1, "candidate_search_included": False, "api_access_included": False},
]
