...
const applicationSchema = new mongoose.Schema(
    {
        ...
        gender: { type: String, required: true, enum: ['Masculino', 'Feminino', 'Binario','Prefiro nao Especificar']  },
        qualification: { type: String, required: true,  enum: ['Ensino Médio', 'Certificado', 'Curso Técnico', 'Grau de Associado', 'Bachelarado', 'Licenciatura', 'Mestrado', 'Doutourado']  },
