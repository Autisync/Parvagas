...
import { parvagasProfileResponseSchema, parvagasSectionSelectionSchema } from "../integrations/parvagas/schemas";
...
export const resumeDto = {
	...
	profilePreview: {
		input: z.void(),
		output: parvagasProfileResponseSchema,
	},
	...
	createFromParvagasProfile: {
		input: z.object({
			...
			selection: parvagasSectionSelectionSchema,
		}),
		output: z.string().describe("The ID of the created resume from Parvagas profile."),
	},
