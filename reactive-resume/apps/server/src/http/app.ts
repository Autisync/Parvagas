...
import { handleParvagasExchange, handleParvagasStart } from "./parvagas-auth";
...
export function createApp() {
	...
	app.get("/auth/parvagas/start", () => handleParvagasStart());
	app.get("/auth/parvagas/exchange", (c) => handleParvagasExchange(c.req.raw));
