	...
	return (
		<DialogContent>
			<DialogHeader>
				...
				<DialogDescription>
					<Trans>
						Continue where you left off by importing an existing resume from Parvagas CV Builder or another compatible
						resume builder. Supported formats include PDF, Microsoft Word, and JSON files exported from this builder.
					</Trans>
				</DialogDescription>
			</DialogHeader>
										...
										options={[
											{
												...
												label: t({
														comment: "Import source option for current Parvagas CV Builder JSON format",
														message: "Parvagas CV Builder (JSON)",
												}),
											},
											{
												value: "reactive-resume-v4-json",
												label: t({
														comment: "Import source option for legacy CV Builder v4 JSON format",
														message: "CV Builder v4 (JSON)",
												}),
											},
											{
