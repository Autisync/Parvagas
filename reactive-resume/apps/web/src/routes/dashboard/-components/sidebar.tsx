		...
		<Sidebar variant="floating" collapsible="icon">
						...
						<SidebarMenuButton
							...
							render={
								<Link to="/">
									...
									<h1 className="sr-only">Parvagas CV Builder</h1>
								</Link>
							}
						/>
					</SidebarMenuItem>
			...
			<SidebarFooter className="gap-y-0">
				<SidebarMenu>
					<SidebarMenuItem>
						<SidebarMenuButton
							title={t`Voltar ao Parvagas`}
							render={
								<a href={branding.mainPlatformUrl} target="_blank" rel="noopener noreferrer">
									<ArrowLeftIcon />
									<span className="shrink-0 transition-[margin,opacity] duration-200 ease-in-out group-data-[collapsible=icon]:-ms-8 group-data-[collapsible=icon]:opacity-0">
										<Trans>Voltar ao Parvagas</Trans>
									</span>
								</a>
							}
						/>
