...
const tagline = "Crie um CV profissional em minutos";
const title = `${appName} — ${tagline}`;
const description =
	"O Parvagas CV Builder ajuda candidatos a criar, atualizar e partilhar curriculos profissionais com rapidez e qualidade.";
const analyticsScriptUrl = String(import.meta.env.VITE_ANALYTICS_SCRIPT_URL ?? "").trim();
const analyticsDomain = String(import.meta.env.VITE_ANALYTICS_DOMAIN ?? "").trim();

export const Route = createRootRouteWithContext<RouterContext>()({
	component: RootComponent,
	head: () => {
		const appUrl = branding.productUrl;
