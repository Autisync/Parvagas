	...
	<section className="relative overflow-hidden bg-linear-to-b from-background via-primary/2 to-background py-24">
		...
		<div className="container relative px-8">
			...
			>
				...
				>
					<Trans>Parvagas CV Builder Support</Trans>
				</m.h2>
				...
				>
					<Trans>
						Parvagas CV Builder is an official Parvagas service. Contact our support team for onboarding, issue
						resolution, and account assistance.
					</Trans>
				</m.p>
			</m.div>
			...
			<div className="mx-auto my-12 grid max-w-5xl gap-8 sm:grid-cols-3">
				<FeatureCard
					icon={RocketIcon}
					title={t`Fast Candidate Onboarding`}
					description={t`Get support to help candidates create CVs quickly and apply to relevant jobs.`}
					delay={0.3}
				/>
				<FeatureCard
					icon={WrenchIcon}
					title={t`Operational Reliability`}
					description={t`Receive help for technical issues, account access, and resume export workflows.`}
					delay={0.4}
				/>
				<FeatureCard
					icon={UsersIcon}
					title={t`Recruitment Ecosystem Integration`}
					description={t`Use CV Builder together with Parvagas jobs, candidate profiles, and support channels.`}
					delay={0.5}
				/>
			</div>
			...
			>
				<Trans>
					Need help with CV Builder setup, login, or exports?
					<br />
