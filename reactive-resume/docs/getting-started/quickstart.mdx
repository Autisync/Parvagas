...
<Steps>
	<Step title="Clone the Repository">
		```bash
		git clone https://github.com/Heliotheanalyst/reactive-resume.git
		cd reactive-resume
		```
	</Step>
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/Heliotheanalyst/reactive-resume/issues) or reach out via
  [email](mailto:hello@Heliotheanalyst.com).
</Note>
