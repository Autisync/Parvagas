...
<AccordionGroup>
	<Accordion title="Completely Free & Open Source" icon="code-branch">
		...
		entire codebase is available on [GitHub](https://github.com/Heliotheanalyst/reactive-resume).
	</Accordion>
...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/Heliotheanalyst/reactive-resume">
...
<Note>
  **Need help?** Feel free to reach out via [email](mailto:hello@Heliotheanalyst.com) or open an issue on GitHub.
</Note>
