...
1. Go to the [GitHub Issues](https://github.com/Heliotheanalyst/reactive-resume/issues) page
2. Click **New Issue**
...
<CardGroup cols={2}>
  ...
  <Card icon="github" title="GitHub Issues" href="https://github.com/Heliotheanalyst/reactive-resume/issues">
