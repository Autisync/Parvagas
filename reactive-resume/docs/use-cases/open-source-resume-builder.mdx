...
The project repository is available on [GitHub](https://github.com/Heliotheanalyst/reactive-resume). You can inspect the code, report issues, contribute improvements, and review how the resume builder, API, self-hosting setup, and documentation are implemented.
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub repository" icon="github" href="https://github.com/Heliotheanalyst/reactive-resume">
