...
- Docker Hub: `Heliotheanalyst/reactive-resume:latest`
- GitHub Container Registry: `ghcr.io/Heliotheanalyst/reactive-resume:latest`
...
services:
  ...
  reactive-resume:
    image: Heliotheanalyst/reactive-resume:latest
    # image: ghcr.io/Heliotheanalyst/reactive-resume:latest
    restart: unless-stopped
    ports:
      - "3000:3000"
    env_file:
...
```
    ...
    <Tip>
      Prefer pulling from Docker Hub? Keep <code>Heliotheanalyst/reactive-resume:latest</code>. Prefer GHCR? Swap it to <code>ghcr.io/Heliotheanalyst/reactive-resume:latest</code>.
    </Tip>
