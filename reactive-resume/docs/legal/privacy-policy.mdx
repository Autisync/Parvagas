...
- **Contact**: hello@Heliotheanalyst.com
...
<Note>
  **Note for self-hosted deployments:** If you are using the official hosted service at <code>rxresu.me</code>, the
  project's published support contact is <code>hello@Heliotheanalyst.com</code>. Replace the placeholders above with the
...
- **Service Operator**: Amruth Pillai
- **Email**: hello@Heliotheanalyst.com
