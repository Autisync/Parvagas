        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-2 lg:max-w-none lg:grid-cols-3">
          {benefits.map((b, i) => {
            ...
            return (
              <article
                key={b.title}
                className="flex flex-col gap-4 rounded-2xl border border-red-100 bg-white p-7 shadow-sm transition hover:shadow-md"
              >
                ...
                <p className="text-sm leading-7 text-gray-600">{b.desc}</p>
              </article>
            );
          })}
        </div>
